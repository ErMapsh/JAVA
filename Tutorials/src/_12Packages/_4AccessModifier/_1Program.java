class anotherClass {
    ...
    protected void meth2() {
        System.out.println(
                "inheritable in anothere class, but not accessible directly. but we can access through another public method");
    }

    private void meth3() {
        System.out
                .println("Not inheritable and not accsiable directly but we can access through another public method");
    }
